<template>
  ...
  const props = withDefaults(defineProps<Props>(), {
    color: "#ffffff",
    quantity: 50,
    speed: 0.1, // Controls how fast the snowflakes fall
    maxRadius: 1.5, // Default max radius
    minRadius: 0.5, // Default min radius
    class: "",
    ease: 0, // Easing factor for the snowflake movement
  });
...
div[ref="canvasContainerRef"] {
  ...
  height: 100%; /* Hauteur fixe, modifiable */
